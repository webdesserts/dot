---
name: hunt
description: A dedicated hunt for ONE defect class (security, races, resource leaks, injection, bypasses) across a scoped surface. Adversarial, empirical, read-only with sanctioned probes.
