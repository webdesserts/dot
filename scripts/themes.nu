...
const default = { fg: default }
const default_dimmed = { fg: default, attr: d }
const default_bold = { fg: default, attr: b }
const default_bold_dimmed = { fg: default, attr: bd }
const default_bold_italic = { fg: default, attr: bi }
...
export const desserts = {
  ...
  shape_range: $default
  shape_internalcall: $default_bold_italic
